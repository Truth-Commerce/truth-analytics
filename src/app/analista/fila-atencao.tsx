...
/**
 * Fila "Atenção hoje" do command center (H4 T5) — orgs da carteira ordenadas
 * por `risco.score` desc (view-model puro em `carteira-view-model.ts`), com
 * badge do nível, top-3 motivos e ações-link: abrir a visão 360 sempre, e
 * "Conexões" quando o motivo é de token (Bling). RSC-safe (sem estado).
 *
